...
//1) Написать функцию, которая выводит список всех сотрудников в список <ul>.
    ...
    for (let employee of employees) {
        ...
        //добавления кнопки Удалить для каждого сотрудника в списке:
...
//
    ...
    { text: " Иван Иванов", value: 133 },

    { text: " Петр Петров", value: 134 }], 133);
...
// получать данные формы, осуществлять поиск и затем выводить результаты
